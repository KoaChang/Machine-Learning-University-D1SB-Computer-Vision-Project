...
setup(
    ...
    #
    # 1. Create the function you want to run on the CLI in src/image_guru_model_inference/cli.py
    #    For convenience I usually recommend calling it main()
    #
    # 2. Uncomment this section of the setup.py arguments; this will create
    #    bin/ImageGuruModelInference (which you can obviously change!) as a script
    #    that will call your main() function, above.
    #
    # entry_points="""\
    # [console_scripts]
    # ImageGuruModelInference = image_guru_model_inference.cli:main
    # """,
    #
